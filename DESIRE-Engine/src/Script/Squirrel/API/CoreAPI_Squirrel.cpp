...
void RegisterVectormathFunctions_Squirrel(Sqrat::RootTable& rootTable)
{
	...
	rootTable.Bind("Vector3", Sqrat::Class<Vector3>(vm, "Vector3")
		...
		.Func("_mul", &Vector3::operator *)
		.Func("_div", &Vector3::operator /)
		...
		.Func("MulPerElem", &Vector3::MulPerElem)
		.Func("DivPerElem", &Vector3::DivPerElem)
	...
	rootTable.Bind("Vector4", Sqrat::Class<Vector4>(vm, "Vector4")
		...
		.Func("_mul", &Vector4::operator *)
		.Func("_div", &Vector4::operator /)
		...
		.Func("MulPerElem", &Vector4::MulPerElem)
		.Func("DivPerElem", &Vector4::DivPerElem)
	...
	rootTable.Bind("Quat", Sqrat::Class<Quat>(vm, "Quat")
		...
		.Ctor<const Vector3&, float>()
		.Ctor<const Matrix3&>()
		.Func("SetXYZ", &Quat::SetXYZ)
		.Func("GetXYZ", &Quat::GetXYZ)
		.Prop("x", &Quat::GetX, &Quat::SetX)
		.Prop("y", &Quat::GetY, &Quat::SetY)
		.Prop("z", &Quat::GetZ, &Quat::SetZ)
		.Prop("w", &Quat::GetW, &Quat::SetW)
		.Func<Quat(Quat::*)() const>("_unm", &Quat::operator -)
		.Func("_add", &Quat::operator +)
		.Func<Quat(Quat::*)(const Quat&) const>("_sub", &Quat::operator -)
		.SquirrelFunc("_mul", &SquirrelScriptAPI<Quat>::OpMulOverrides<const Quat&, float>)
		.Func("_div", &Quat::operator /)
		.Func("Dot", &Quat::Dot)
		.Func("Norm", &Quat::Norm)
