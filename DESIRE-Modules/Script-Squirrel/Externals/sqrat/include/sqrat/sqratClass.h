...
public:
	...
	///
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	Class(HSQUIRRELVM v, const String& className, bool createClass = true)
		: Object(v, false)
	{
		if(createClass && !ClassType<C>::hasClassData(v))
		{
			...
			*ud = new ClassData<C>;
			...
			if(ClassType<C>::getStaticClassData().expired())
			{
				...
				cd->staticData->className = className;
...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/// Binds a constructor with N arguments (there can only be one constructor of a number of arguments for a given name)
	///
	/// \param name Name of the constructor as it will appear in Squirrel (default value creates a traditional constructor)
	///
	/// \tparam A1 Type of argument 1 of the constructor (must be defined explicitly)
	/// \tparam AN Type of argument N of the constructor (must be defined explicitly)
	///
	/// \return The Class itself so the call can be chained
	///
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
